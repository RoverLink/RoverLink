...
final kTranslationsMap = <Map<String, Map<String, String>>>[
  // ReportAbsence
  {
    ...
    'cibsn1fo': {
      ...
      'it': 'Seleziona un livello scolastico',
      'ja': '学年を選択してください',
      'zh_Hans': '请选择年级',
    },
    'a2wcicz4': {
    ...
    '3c4nk704': {
      ...
      'it': 'Firma del genitore o del tutore',
      'ja': '親または保護者の署名',
      'zh_Hans': '家长或监护人签名',
    },
    'lqihzcox': {
      ...
      'it': 'Firma con il tuo nome nella casella sottostante',
      'ja': '下のボックスにあなたの名前を署名してください',
    ...
    '6qrnuoul': {
      ...
      'it': 'Inserisci il nome completo dello studente',
      'ja': '学生のフルネームを入力してください',
      'zh_Hans': '请输入学生全名',
    },
    'yl7jmd83': {
      'en': 'Please enter full name of student',
    ...
    'mlgmzzoo': {
      ...
      'it': 'Deve essere fornito un motivo per l\'assenza dello studente',
      'ja': '学生の欠席の理由を提供する必要があります',
      'zh_Hans': '必须提供学生缺勤的原因',
    },
    'zxot1wum': {
      'en': 'Please choose an option from the dropdown',
  ...
  // Links
  {
    ...
    'n6ghu275': {
      ...
      'it': 'FD MealPlanner (menù caffetteria)',
      'ja': 'FD MealPlanner（カフェテリアメニュー）',
    ...
    'q0tcbl2n': {
      ...
      'it': 'SchoolCafé (Informazioni caffetteria)',
      'ja': 'SchoolCafé（カフェテリア情報）',
    ...
    'qs7rdxvy': {
      ...
      'it': 'Riunioni del consiglio di amministrazione dell\'EASD',
      'ja': 'EASD理事会',
      'zh_Hans': 'EASD 董事会会议',
    },
    'ouwg0nnr': {
      ...
      'it': 'Altri collegamenti (sito Web EASD)',
      'ja': 'その他のリンク (EASD Web サイト)',
    ...
    'tkzxsjla': {
      ...
      'it': 'Più collegamenti (intelligente)',
      'ja': 'その他のリンク (賢い)',
      'zh_Hans': '更多链接（聪明）',
    },
    'apdrlayk': {
  ...
  // YourProfile
  {
    ...
    'c6d9mukv': {
      ...
      'it': 'Non hai ancora pubblicato nulla.',
      'ja': 'まだ何も投稿していません。',
      'zh_Hans': '您还没有发布任何内容。',
    },
    '3eryex94': {
  ...
  // EditProfile
  {
    ...
    'qz53miub': {
      ...
      'it': 'Il nome utente deve contenere almeno 5 caratteri',
      'ja': 'ユーザー名は 5 文字以上にする必要があります',
    ...
    'rqm8092b': {
      ...
      'it': 'Il nome utente può contenere al massimo 15 caratteri',
      'ja': 'ユーザー名は最大 15 文字です',
    ...
    'oxx5e4zi': {
      ...
      'it':
          'I nomi utente possono contenere solo lettere, numeri e caratteri di sottolineatura',
      'ja': 'ユーザー名には文字、数字、アンダースコアのみを使用できます',
  ...
  // ForgotPassword
  {
    'r9qondpm': {
      ...
      'it':
          'Ti invieremo un\'e-mail con un link per reimpostare la tua password, inserisci l\'e-mail associata al tuo account di seguito.',
      'ja':
  ...
  // Notifications
  {
    ...
    '2hest3cb': {
      ...
      'de': 'Sie haben noch keine Benachrichtigungen erhalten.',
      'es': 'Aún no has recibido ninguna notificación.',
      'fr': 'Vous n\'avez pas encore reçu de notifications.',
      'it': 'Non hai ancora ricevuto alcuna notifica.',
      'ja': 'まだ通知を受け取っていません。',
      'zh_Hans': '您还没有收到任何通知。',
    },
    'itr8nwq2': {
  ...
  // EAHS
  {
    ...
    'z2acb03f': {
      ...
      'it':
          'Liceo della zona di Easton\n2601 William Penn Hwy, Easton, PA 18045\n(610) 250-2481',
      'ja': 'イーストンエリア高校\n2601 ウィリアム ペン ハイウェイ、イーストン、PA 18045\n(610) 250-2481',
      'zh_Hans':
  ...
  // CreatePost
  {
    ...
    's1ftfujq': {
      ...
      'de': 'Etwas teilen...',
      'es': 'Comparte algo...',
      'fr': 'Partage quelque chose...',
      'it': 'Condividi qualcosa...',
      'ja': '何かを共有...',
      'zh_Hans': '分享一些东西...',
    },
    'dibo4g0i': {
