...
class NewCalendarWidget extends StatefulWidget {
  const NewCalendarWidget({Key? key}) : super(key: key);

  @override
  _NewCalendarWidgetState createState() => _NewCalendarWidgetState();
}

class _NewCalendarWidgetState extends State<NewCalendarWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          backgroundColor: Color(0xFF404D59),
                          ...
                          children: [
                            ...
                            FutureBuilder<ApiCallResponse>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final listViewCalendarResponse = snapshot.data!;
                                return Builder(
                                  builder: (context) {
