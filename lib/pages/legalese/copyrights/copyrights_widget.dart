...
class _CopyrightsWidgetState extends State<CopyrightsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CopyrightsModel());
  }
            ...
            children: [
              Expanded(
                child: FlutterFlowWebView(
                  content: 'https://roverlink.github.io/CopyrightAndLicensing',
                  bypass: false,
