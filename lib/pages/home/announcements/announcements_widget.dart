...
<<<<<<< HEAD:lib/announcements/announcements_widget.dart
        actions: [],
        centerTitle: true,
        elevation: 0,
      ),
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'qvia11pf' /* FBLA Second Harvest Food Bank */,
                                            ),
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'dz3vuyws' /* St. Lukes Volunteering */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .titleMedium
                                                .override(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              '18b8e4bl' /* End of School for Students */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .titleMedium
                                                .override(
